...
<div class="wpie_element_full_wrapper">
    <div class="wpie_element_title">
        <?php esc_html_e('Onedrive Client Id', 'woo-import-export'); ?>
         <div class="wpie_import_title_hint">
            <a class="wpie_import_title_hint_link" target="_blank" href="https://docs.microsoft.com/en-us/onedrive/developer/controls/file-pickers/js-v72/?view=odsp-graph-online"><i class="wpie_support_icon far fa-question-circle"></i><?php esc_html_e('File Picker Doc and Client Id', 'woo-import-export'); ?></a>
        </div>
    </div>
