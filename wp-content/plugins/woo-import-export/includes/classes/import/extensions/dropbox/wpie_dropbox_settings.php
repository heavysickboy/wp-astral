...
<div class="wpie_element_full_wrapper">
    <div class="wpie_element_title">
        <?php esc_html_e('DropBox App Key', 'woo-import-export'); ?>
        <div class="wpie_import_title_hint">
            <a class="wpie_import_title_hint_link" target="_blank" href="https://www.dropbox.com/developers/chooser"><i class="wpie_support_icon far fa-question-circle"></i><?php esc_html_e('Chooser Doc and APP key', 'woo-import-export'); ?></a>
        </div>
    </div>
