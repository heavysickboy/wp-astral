                ...
                <div class="wpie_download_btn_wrapper">
                        <?php if ( $is_valid ) { ?>
                                <div class="wpie_btn wpie_btn_primary wpie_dropbox_upload_btn">
                                        <i class="fab fa-dropbox wpie_general_btn_icon " aria-hidden="true"></i><?php esc_html_e( 'Choose From Dropbox ', 'woo-import-export' ); ?>
                                </div>
                        <?php } ?>
                        <a class="wpie_btn wpie_btn_primary wpie_dropbox_config_btn" href="<?php echo esc_url( $dConfingUrl ); ?>">
                                <i class="fas fa-cog wpie_general_btn_icon " aria-hidden="true"></i><?php esc_html_e( 'Configure Dropbox ', 'woo-import-export' ); ?>
                        </a>
                </div>
        </div>
