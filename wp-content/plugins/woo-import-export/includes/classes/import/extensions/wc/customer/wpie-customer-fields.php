...
if ( !function_exists( "wpie_import_wc_customer_mapping_fields" ) ) {
        ...
        function wpie_import_wc_customer_mapping_fields( $sections = [], $wpie_import_type = "" ) {
                ...
                <div class="wpie_field_mapping_container_wrapper">
                        <div class="wpie_field_mapping_container_title"><?php esc_html_e( 'Billing & Shipping Details', 'woo-import-export' ); ?><div class="wpie_layout_header_icon_wrapper"><i class="fas fa-chevron-up wpie_layout_header_icon wpie_layout_header_icon_collapsed" aria-hidden="true"></i><i class="fas fa-chevron-down wpie_layout_header_icon wpie_layout_header_icon_expand" aria-hidden="true"></i></div></div>
                        <div class="wpie_field_mapping_container_data">
                                <div class="wpie_product_data_section">
                                        <div class="wpie_customer_menu_wrapper">
                                                <div class="wpie_customer_item_list wpie_customer_item_billing active_tab" display_block="wpie_customer_billing_wrapper"><?php esc_html_e( 'Billing', 'woo-import-export' ); ?></div>
                                                <div class="wpie_customer_item_list wpie_customer_item_shipping" display_block="wpie_customer_shipping_wrapper"><?php esc_html_e( 'Shipping', 'woo-import-export' ); ?></div>
                                        </div>
                                                        ...
                                                        <div class="wpie_customer_billing_field_container">
                                                                <div class="wpie_customer_billing_data">
                                                                        <div class="wpie_customer_billing_data_outer">
                                                                                <div class="wpie_customer_billing_data_inner">
                                                                                        <div class="wpie_customer_billing_data_label">
                                                                                            <?php esc_html_e( 'First Name', 'woo-import-export' ); ?>
                                                                                        </div>
                                                                                ...
                                                                                <div class="wpie_customer_billing_data_inner">
                                                                                        <div class="wpie_customer_billing_data_label">
                                                                                            <?php esc_html_e( 'Last Name', 'woo-import-export' ); ?>
                                                                                        </div>
                                                                                        <div class="wpie_customer_billing_data_container">
                                                                        ...
                                                                        <div class="wpie_customer_billing_data_outer">
                                                                                <div class="wpie_customer_billing_data_inner">
                                                                                        <div class="wpie_customer_billing_data_label">
                                                                                            <?php esc_html_e( 'Address 1', 'woo-import-export' ); ?>
                                                                                        </div>
                                                                                        <div class="wpie_customer_billing_data_container">
                                                                                ...
                                                                                <div class="wpie_customer_billing_data_inner">
                                                                                        <div class="wpie_customer_billing_data_label">
                                                                                            <?php esc_html_e( 'Address 2', 'woo-import-export' ); ?>
                                                                                        </div>
                                                                                        <div class="wpie_customer_billing_data_container">
                                                                        ...
                                                                        <div class="wpie_customer_billing_data_outer">
                                                                                <div class="wpie_customer_billing_data_inner">
                                                                                        <div class="wpie_customer_billing_data_label">
                                                                                            <?php esc_html_e( 'City', 'woo-import-export' ); ?>
                                                                                        </div>
                                                                                        <div class="wpie_customer_billing_data_container">
                                                                                ...
                                                                                <div class="wpie_customer_billing_data_inner">
                                                                                        <div class="wpie_customer_billing_data_label">
                                                                                            <?php esc_html_e( 'Postcode', 'woo-import-export' ); ?>
                                                                                        </div>
                                                                                        <div class="wpie_customer_billing_data_container">
                                                                        ...
                                                                        <div class="wpie_customer_billing_data_outer">
                                                                                <div class="wpie_customer_billing_data_inner">
                                                                                        <div class="wpie_customer_billing_data_label">
                                                                                            <?php esc_html_e( 'Country', 'woo-import-export' ); ?>
                                                                                        </div>
                                                                                        <div class="wpie_customer_billing_data_container">
                                                                                ...
                                                                                <div class="wpie_customer_billing_data_inner">
                                                                                        <div class="wpie_customer_billing_data_label">
                                                                                            <?php esc_html_e( 'State/Country', 'woo-import-export' ); ?>
                                                                                        </div>
                                                                                        <div class="wpie_customer_billing_data_container">
                                                                        ...
                                                                        <div class="wpie_customer_billing_data_outer">
                                                                                <div class="wpie_customer_billing_data_inner">
                                                                                        <div class="wpie_customer_billing_data_label">
                                                                                            <?php esc_html_e( 'Email', 'woo-import-export' ); ?>
                                                                                        </div>
                                                                                        <div class="wpie_customer_billing_data_container">
                                                                                ...
                                                                                <div class="wpie_customer_billing_data_inner">
                                                                                        <div class="wpie_customer_billing_data_label">
                                                                                            <?php esc_html_e( 'Phone', 'woo-import-export' ); ?>
                                                                                        </div>
                                                                                        <div class="wpie_customer_billing_data_container">
                                                                        ...
                                                                        <div class="wpie_customer_billing_data_outer">
                                                                                <div class="wpie_customer_billing_data_inner">
                                                                                        <div class="wpie_customer_billing_data_label">
                                                                                            <?php esc_html_e( 'Company', 'woo-import-export' ); ?>
                                                                                        </div>
                                                                                        <div class="wpie_customer_billing_data_container">
                                                        ...
                                                        <div class="wpie_customer_shipping_field_container">
                                                                <div class="wpie_product_element_data_container">
                                                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                                                ...
                                                                                <label for="wpie_item_customer_shipping_source_copy" class="wpie_radio_label"><?php esc_html_e( 'Copy from billing', 'woo-import-export' ); ?></label>
                                                                        </div>
                                                                        <div class="wpie_product_element_wrapper">
                                                                                ...
                                                                                <label for="wpie_item_customer_shipping_source_import" class="wpie_radio_label"><?php esc_html_e( 'Import shipping address', 'woo-import-export' ); ?></label>
