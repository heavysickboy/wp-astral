...
<div class="wpie_upload_outer_container">
        ...
        <div class="wpie_text_format_list_wrapper">
                <div class="wpie_text_format_list_header"><?php esc_html_e( 'Data Format', 'woo-import-export' ); ?></div>
                <div class="wpie_text_format_list_container">
                        <div class="wpie_text_format_list_element" >
                                ...
                                <label class="wpie_text_format_list_data wpie_radio_label"  for="wpie_text_format_list_csv"><?php esc_html_e( 'CSV', 'woo-import-export' ); ?></label>
                        </div>
                        <div class="wpie_text_format_list_element" >
                                ...
                                <label class="wpie_text_format_list_data wpie_radio_label"  for="wpie_text_format_list_json"><?php esc_html_e( 'JSON', 'woo-import-export' ); ?></label>
                        </div>
                        <div class="wpie_text_format_list_element" >
                                ...
                                <label class="wpie_text_format_list_data wpie_radio_label"  for="wpie_text_format_list_xml"><?php esc_html_e( 'XML', 'woo-import-export' ); ?></label>
                        </div>
                </div>
        </div>
</div>