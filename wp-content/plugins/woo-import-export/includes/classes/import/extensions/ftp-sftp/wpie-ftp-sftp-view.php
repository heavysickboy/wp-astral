...
<div class="wpie_upload_outer_container" >
        ...
        <div  class="wpie_file_upload_container wpie_ftp_upload_container">
                <div class="wpie_element_half_wrapper">
                        <div class="wpie_element_title"><?php esc_html_e( 'Server', 'woo-import-export' ); ?></div>
                ...
                <div class="wpie_element_half_wrapper">
                        <div class="wpie_element_title"><?php esc_html_e( 'Port', 'woo-import-export' ); ?></div>
                        <div class="wpie_element_data">
                ...
                <div class="wpie_element_half_wrapper">
                        <div class="wpie_element_title"><?php esc_html_e( 'Username', 'woo-import-export' ); ?></div>
                        <div class="wpie_element_data">
                                <input class="wpie_content_data_input wpie_ftp_host_username" type="text" name="wpie_ftp_host_username" value="">
                        </div>
                </div>
                <div class="wpie_element_half_wrapper">
                        <div class="wpie_element_title"><?php esc_html_e( 'Password', 'woo-import-export' ); ?></div>
                        <div class="wpie_element_data">
                ...
                <div class="wpie_element_full_wrapper">
                        <div class="wpie_element_title"><?php esc_html_e( 'Path', 'woo-import-export' ); ?></div>
                        <div class="wpie_element_data">
                ...
                <div class="wpie_element_full_wrapper">
                        <div class="wpie_element_title"><?php esc_html_e( 'Connection Type', 'woo-import-export' ); ?></div>
                        <div class="wpie_element_data wpie_connection_type_wrapper">
                                <div class="wpie_radio_wrapper">
                                        ...
                                        <label for="wpie_connection_type_ftp" class="wpie_radio_label"><?php esc_html_e( 'FTP', 'woo-import-export' ); ?></label>                                                       
                                </div>
                                <div class="wpie_radio_wrapper">
                                        <input type="radio" class="wpie_radio wpie_connection_type" name="wpie_connection_type" id="wpie_connection_type_ftps" value="ftps"/>
                                        <label for="wpie_connection_type_ftps" class="wpie_radio_label"><?php esc_html_e( 'FTPS (SSL)', 'woo-import-export' ); ?></label>                                                       
                                </div>
                                <div class="wpie_radio_wrapper">
                                        <input type="radio" class="wpie_radio wpie_connection_type" name="wpie_connection_type" id="wpie_connection_type_sftp" value="sftp"/>
                                        <label for="wpie_connection_type_sftp" class="wpie_radio_label"><?php esc_html_e( 'SSH2 / SFTP', 'woo-import-export' ); ?></label>                                                       
                                </div>
                        </div>
                </div>
