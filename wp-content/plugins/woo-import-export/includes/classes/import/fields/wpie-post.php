...
if ( !function_exists( "wpie_import_post_mapping_fields" ) ) {
        ...
        function wpie_import_post_mapping_fields( $sections = array(), $wpie_import_type = "" ) {
                ...
                <div class="wpie_field_mapping_container_wrapper">
                        <div class="wpie_field_mapping_container_title wpie_active"><?php esc_html_e( 'Title & Content', 'woo-import-export' ); ?><div class="wpie_layout_header_icon_wrapper"><i class="fas fa-chevron-up wpie_layout_header_icon wpie_layout_header_icon_collapsed" aria-hidden="true"></i><i class="fas fa-chevron-down wpie_layout_header_icon wpie_layout_header_icon_expand" aria-hidden="true"></i></div></div>
                        <div class="wpie_field_mapping_container_data wpie_show">
                                <div class="wpie_field_mapping_container_element">
                                        <div class="wpie_field_mapping_inner_title"><?php esc_html_e( 'Post Title', 'woo-import-export' ); ?> *</div>
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                <input type="text" class="wpie_content_data_input wpie_item_title" name="wpie_item_title" placeholder="<?php esc_attr_e( 'Title', 'woo-import-export' ); ?>"/>
                                                <div class="wpie_required_field_notice"><?php esc_html_e( 'Note : Title is required field for new items. Optional for update items', 'woo-import-export' ); ?></div>
                                        </div>
                                </div>
                                <div class="wpie_field_mapping_container_element wpie_import_content_editor_wrapper wpie_hide_if_shop_coupon">
                                        <div class="wpie_field_mapping_inner_title"><?php esc_html_e( 'Post Content', 'woo-import-export' ); ?></div>
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                <textarea class="wpie_content_data_textarea wpie_item_content" placeholder="<?php esc_attr_e( 'Content', 'woo-import-export' ); ?>" name="wpie_item_content"></textarea>
                                                <div class="wpie_content_options">
                                                        <div class="wpie_field_mapping_radio_input_wrapper">
                                                                ...
                                                                <label class="wpie_checkbox_label" for="wpie_item_import_img_tags"><?php esc_html_e( 'Search image through content and import images wrapped in <img> tags ', 'woo-import-export' ); ?></label>
                                                        </div>
                                                </div>
                                        </div>
                                </div>
                                <div class="wpie_field_mapping_container_element">
                                        <div class="wpie_field_mapping_inner_title"><?php esc_html_e( 'Post Excerpt', 'woo-import-export' ); ?></div>
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                <input type="text" class="wpie_content_data_input wpie_item_excerpt" name="wpie_item_excerpt" placeholder="<?php esc_attr_e( 'Excerpt', 'woo-import-export' ); ?>"/>
                                        </div>
                                </div>
                        </div>
                </div>
                ...
                ?>
                <div class="wpie_field_mapping_container_wrapper">
                        <div class="wpie_field_mapping_container_title"><?php esc_html_e( 'Images', 'woo-import-export' ); ?><div class="wpie_layout_header_icon_wrapper"><i class="fas fa-chevron-up wpie_layout_header_icon wpie_layout_header_icon_collapsed" aria-hidden="true"></i><i class="fas fa-chevron-down wpie_layout_header_icon wpie_layout_header_icon_expand" aria-hidden="true"></i></div></div>
                                ...
                                <div class="wpie_field_mapping_container_element">
                                        <div class="wpie_image_download_options">
                                                <div class="wpie_field_mapping_radio_input_wrapper wpie_radio_wrapper">
                                                        ...
                                                        <label for="wpie_download_images" class="wpie_radio_label"><?php esc_html_e( 'Download images hosted elsewhere', 'woo-import-export' ); ?><i class="far fa-question-circle wpie_data_tipso" data-tipso="<?php esc_attr_e( "Image URL with http:// or https://", "woo-import-export" ); ?>"></i></label>
                                                        <div class="wpie_radio_container">
                                                                <div class="wpie_field_mapping_image_separator_wrapper">
                                                                        <div class="wpie_field_mapping_image_separator"><?php esc_html_e( 'Enter image filenames one per line, or separate them with a', 'woo-import-export' ); ?></div>
                                                                ...
                                                                <textarea class="wpie_content_data_textarea wpie_item_image_url" name="wpie_item_image_url" placeholder="<?php esc_attr_e( 'URL', 'woo-import-export' ); ?>"></textarea>
                                                        </div>
                                                </div>
                                                <div class="wpie_field_mapping_radio_input_wrapper">
                                                        ...
                                                        <label for="wpie_media_library" class="wpie_radio_label"><?php esc_html_e( 'Use images currently in Media Library', 'woo-import-export' ); ?></label>
                                                        <div class="wpie_radio_container">
                                                                <div class="wpie_field_mapping_image_separator_wrapper">
                                                                        <div class="wpie_field_mapping_image_separator"><?php esc_html_e( 'Enter image filenames one per line, or separate them with a', 'woo-import-export' ); ?></div>
                                                                ...
                                                                <textarea class="wpie_content_data_textarea wpie_item_image_media_library" name="wpie_item_image_media_library" placeholder="<?php esc_attr_e( 'Images.jpg', 'woo-import-export' ); ?>"></textarea>
                                                        </div>
                                                </div>
                                                <div class="wpie_field_mapping_radio_input_wrapper">
                                                        ...
                                                        <label for="wpie_local_images" class="wpie_radio_label"><?php echo esc_html( __( 'Use images currently uploaded in', 'woo-import-export' ) . " " . WPIE_UPLOAD_TEMP_DIR ); ?> </label>
                                                        <div class="wpie_radio_container">
                                                                <div class="wpie_field_mapping_image_separator_wrapper">
                                                                        <div class="wpie_field_mapping_image_separator"><?php esc_html_e( 'Enter image filenames one per line, or separate them with a', 'woo-import-export' ); ?></div>
                                                                ...
                                                                <textarea class="wpie_content_data_textarea wpie_item_image_local" name="wpie_item_image_local" placeholder="<?php esc_attr_e( 'Images.jpg', 'woo-import-export' ); ?>"></textarea>
                                                        </div>
                                                </div>
                                        </div>
                                        <div class="wpie_field_mapping_inner_title"><?php esc_html_e( 'Image Options', 'woo-import-export' ); ?></div>
                                        <div class="wpie_image_option_wrapper">
                                                <div class="wpie_field_mapping_radio_input_wrapper wpie_image_media_option_data">
                                                        ...
                                                        <label class="wpie_checkbox_label" for="wpie_item_search_existing_images"><?php esc_html_e( 'Search through the Media Library for existing images before importing new images', 'woo-import-export' ); ?><i class="far fa-question-circle wpie_data_tipso" data-tipso="<?php esc_attr_e( "If an image with the same file name or remote URL is found in the Media Library then that image will be attached to this record instead of importing a new image. Disable this setting if you always want to download a new image.", "woo-import-export" ); ?>"></i></label>
                                                </div>
                                                <div class="wpie_field_mapping_radio_input_wrapper wpie_image_media_option_data">
                                                        ...
                                                        <label class="wpie_checkbox_label" for="wpie_item_keep_images"><?php esc_html_e( 'Keep images currently in Media Library', 'woo-import-export' ); ?><i class="far fa-question-circle wpie_data_tipso" data-tipso="<?php esc_attr_e( "If disabled, images attached to imported posts will be deleted and then all images will be imported.", "woo-import-export" ); ?>"></i></label>
                                                </div> 
                                                <div class="wpie_field_mapping_radio_input_wrapper">
                                                        ...
                                                        <label class="wpie_checkbox_label" for="wpie_item_first_imaege_is_featured"><?php esc_html_e( 'Set the first image to the Featured Image (_thumbnail_id)', 'woo-import-export' ); ?></label>
                                                </div>                                                
                                                <div class="wpie_field_mapping_radio_input_wrapper">
                                                        ...
                                                        <label class="wpie_checkbox_label" for="wpie_item_unsuccess_set_draft"><?php esc_html_e( 'If no images are downloaded successfully, create entry as Draft.', 'woo-import-export' ); ?></label>
                                                </div>
                                        </div>
                                        <div class="wpie_field_advanced_option_wrapper">
                                                <div class="wpie_field_mapping_inner_title"><?php esc_html_e( 'Media SEO & Advanced Options', 'woo-import-export' ); ?></div>
                                                <div class="wpie_field_advanced_option_container">
                                                        <div class="wpie_field_advanced_option_data_lbl"><?php esc_html_e( 'Meta Data', 'woo-import-export' ); ?></div>
                                                        <div class="wpie_field_advanced_option_data_container">
                                                                <div class="wpie_field_mapping_radio_input_wrapper">
                                                                        ...
                                                                        <label for="wpie_item_set_image_title" class="wpie_checkbox_label"><?php esc_html_e( 'Set Title(s)', 'woo-import-export' ); ?></label>
                                                                        <div class="wpie_checkbox_container">
                                                                                <div class="wpie_field_mapping_container_element" >
                                                                                        <div class="wpie_field_mapping_image_separator"><?php esc_html_e( 'Enter one per line, or separate them with a', 'woo-import-export' ); ?></div>
                                                                                ...
                                                                                <div class="wpie_import_image_seo_hint"><?php esc_html_e( 'The first title will be linked to the first image, the second title will be linked to the second image, ...', 'woo-import-export' ); ?></div>
                                                                                <div class="wpie_field_mapping_container_element">
                                                                ...
                                                                <div class="wpie_field_mapping_radio_input_wrapper">
                                                                        ...
                                                                        <label for="wpie_item_set_image_caption" class="wpie_checkbox_label"><?php esc_html_e( 'Set Caption(s)', 'woo-import-export' ); ?></label>
                                                                        <div class="wpie_checkbox_container">
                                                                                <div class="wpie_field_mapping_container_element" >
                                                                                        <div class="wpie_field_mapping_image_separator"><?php esc_html_e( 'Enter one per line, or separate them with a', 'woo-import-export' ); ?></div>
                                                                                ...
                                                                                <div class="wpie_import_image_seo_hint"><?php esc_html_e( 'The first caption will be linked to the first image, the second caption will be linked to the second image, ...', 'woo-import-export' ); ?></div>
                                                                                <div class="wpie_field_mapping_container_element">
                                                                ...
                                                                <div class="wpie_field_mapping_radio_input_wrapper">
                                                                        ...
                                                                        <label for="wpie_item_set_image_alt" class="wpie_checkbox_label"><?php esc_html_e( 'Set Alt Text(s)', 'woo-import-export' ); ?></label>
                                                                        <div class="wpie_checkbox_container">
                                                                                <div class="wpie_field_mapping_container_element" >
                                                                                        <div class="wpie_field_mapping_image_separator"><?php esc_html_e( 'Enter one per line, or separate them with a', 'woo-import-export' ); ?></div>
                                                                                ...
                                                                                <div class="wpie_import_image_seo_hint"><?php esc_html_e( 'The first alt text will be linked to the first image, the second alt text will be linked to the second image, ...', 'woo-import-export' ); ?></div>
                                                                                <div class="wpie_field_mapping_container_element">
                                                                ...
                                                                <div class="wpie_field_mapping_radio_input_wrapper">
                                                                        ...
                                                                        <label for="wpie_item_set_image_description" class="wpie_checkbox_label"><?php esc_html_e( 'Set Description(s)', 'woo-import-export' ); ?></label>
                                                                        <div class="wpie_checkbox_container">
                                                                                <div class="wpie_field_mapping_container_element" >
                                                                                        <div class="wpie_field_mapping_image_separator"><?php esc_html_e( 'Enter one per line, or separate them with a', 'woo-import-export' ); ?></div>
                                                                                ...
                                                                                <div class="wpie_import_image_seo_hint"><?php esc_html_e( 'The first description will be linked to the first image, the second description will be linked to the second image, ...', 'woo-import-export' ); ?></div>
                                                                                <div class="wpie_field_mapping_container_element">
                                                ...
                                                <div class="wpie_field_advanced_option_container">
                                                        <div class="wpie_field_advanced_option_data_lbl"><?php esc_html_e( 'Files', 'woo-import-export' ); ?></div>
                                                        <div class="wpie_field_advanced_option_data_container">
                                                                <div class="wpie_field_mapping_radio_input_wrapper">
                                                                        ...
                                                                        <label for="wpie_item_image_rename" class="wpie_checkbox_label"><?php esc_html_e( 'Change image file names to', 'woo-import-export' ); ?></label>
                                                                        <div class="wpie_checkbox_container">
                                                                                <div class="wpie_field_mapping_container_element" >
                                                                                        <div class="wpie_field_mapping_image_separator"><?php esc_html_e( 'Enter one per line, or separate them with a', 'woo-import-export' ); ?></div>
                                                                ...
                                                                <div class="wpie_field_mapping_radio_input_wrapper">
                                                                        ...
                                                                        <label for="wpie_item_change_ext" class="wpie_checkbox_label"><?php esc_html_e( 'Change image file extensions', 'woo-import-export' ); ?></label>
                                                                        <div class="wpie_checkbox_container">
                                                                                <div class="wpie_field_mapping_container_element" >
                                                                                        <div class="wpie_field_mapping_image_separator"><?php esc_html_e( 'Enter one per line, or separate them with a', 'woo-import-export' ); ?></div>
                ...
                ?>
                <div class="wpie_field_mapping_container_wrapper">
                        <div class="wpie_field_mapping_container_title"><?php esc_html_e( 'Custom Fields', 'woo-import-export' ); ?><div class="wpie_layout_header_icon_wrapper"><i class="fas fa-chevron-up wpie_layout_header_icon wpie_layout_header_icon_collapsed" aria-hidden="true"></i><i class="fas fa-chevron-down wpie_layout_header_icon wpie_layout_header_icon_expand" aria-hidden="true"></i></div></div>
                        <div class="wpie_field_mapping_container_data">
                ...
                if ( !empty( $wpie_post_taxonomies ) ) {
                        ...
                        ?>
                        <div class="wpie_field_mapping_container_wrapper">
                                <div class="wpie_field_mapping_container_title"><?php esc_html_e( 'Taxonomies, Categories, Tags', 'woo-import-export' ); ?><div class="wpie_layout_header_icon_wrapper"><i class="fas fa-chevron-up wpie_layout_header_icon wpie_layout_header_icon_collapsed" aria-hidden="true"></i><i class="fas fa-chevron-down wpie_layout_header_icon wpie_layout_header_icon_expand" aria-hidden="true"></i></div></div>
                                <div class="wpie_field_mapping_container_data">
                                                                ...
                                                                <div class="wpie_field_mapping_radio_input_wrapper wpie_field_mapping_cat_inner_wrapper">
                                                                        <div class="wpie_cat_inner_data_wrapper">
                                                                                ...
                                                                                <div class="wpie_half_container wpie_taxonomy_delim_wrapper">
                                                                                        <div class="wpie_field_mapping_image_separator"><?php esc_html_e( 'Separate by', 'woo-import-export' ); ?></div>
                                                                        ...
                                                                        <?php if ( $tax->hierarchical ) { ?>
                                                                                <div class="wpie_cat_inner_data_wrapper wpie_cat_group_sep_wrapper wpie_cat_sep_wrapper">
                                                                                        <div class="wpie_field_mapping_image_separator"><?php echo esc_html( sprintf( __( 'Separate %s hierarchy (parent/child) via symbol (i.e. Clothing > Men > TShirts)', 'woo-import-export' ), $name ) ); ?></div>
                                                                                ...
                                                                                <div class="wpie_cat_inner_data_wrapper">
                                                                                        ...
                                                                                        <label for="wpie_item_taxonomy_child_only_<?php echo esc_attr( $slug ); ?>" class="wpie_checkbox_label"><?php echo esc_html( sprintf( __( 'Only assign %s to the bottom level term in the hierarchy', 'woo-import-export' ), $name ) ); ?></label>                                            
                                                                                </div>
                                                                        <?php } ?>
                                                                </div>
                                                        </div>
                ...
                <div class="wpie_field_mapping_container_wrapper wpie_other_item_option_wrapper">
                        <div class="wpie_field_mapping_container_title"><?php echo esc_html( __( 'Other', 'woo-import-export' ) . ' ' . $wpie_import_type_title . ' ' . __( 'Options', 'woo-import-export' ) ); ?> <div class="wpie_layout_header_icon_wrapper"><i class="fas fa-chevron-up wpie_layout_header_icon wpie_layout_header_icon_collapsed" aria-hidden="true"></i><i class="fas fa-chevron-down wpie_layout_header_icon wpie_layout_header_icon_expand" aria-hidden="true"></i></div></div>
                        <div class="wpie_field_mapping_container_data  wpie_field_mapping_other_option_outer_wrapper">
                                <div class="wpie_field_mapping_container_element">
                                        <div class="wpie_field_mapping_inner_title"><?php esc_html_e( 'Post Status', 'woo-import-export' ); ?></div>
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                ...
                                                <label for="wpie_field_mapping_post_type_published" class="wpie_radio_label"><?php esc_html_e( 'Published', 'woo-import-export' ); ?></label>
                                        </div>
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                ...
                                                <label for="wpie_field_mapping_post_type_draft" class="wpie_radio_label"><?php esc_html_e( 'Draft', 'woo-import-export' ); ?></label>
                                        </div>
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                ...
                                                <label for="wpie_field_mapping_post_type_as_specified" class="wpie_radio_label"><?php esc_html_e( 'As specified', 'woo-import-export' ); ?></label>
                                                <div class="wpie_radio_container wpie_as_specified_wrapper">
                                                        ...
                                                        <i class="far fa-question-circle wpie_data_tipso" data-tipso="<?php esc_attr_e( "The value should be one of the following: ('publish', 'draft', 'trash', 'private').", "woo-import-export" ); ?>"></i>
                                                </div>
                                        </div>
                                </div>
                                <div class="wpie_field_mapping_container_element">
                                        <div class="wpie_field_mapping_inner_title"><?php esc_html_e( 'Post Dates', 'woo-import-export' ); ?></div>
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                ...
                                                <label for="wpie_field_mapping_post_date_now" class="wpie_radio_label"><?php esc_html_e( 'Now', 'woo-import-export' ); ?></label>
                                        </div>
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                ...
                                                <label for="wpie_field_mapping_post_date_as_specified" class="wpie_radio_label"><?php esc_html_e( 'As specified', 'woo-import-export' ); ?></label>
                                                <div class="wpie_radio_container wpie_as_specified_wrapper">
                                                        ...
                                                        <i class="far fa-question-circle wpie_data_tipso" data-tipso="<?php esc_attr_e( "Use any format supported by the PHP strtotime function. That means pretty much any human-readable date will work.", "woo-import-export" ); ?>"></i>
                                                </div>
                                        </div>
                                </div>
                                <div class="wpie_field_mapping_container_element">
                                        <div class="wpie_field_mapping_inner_title"><?php esc_html_e( 'Comments', 'woo-import-export' ); ?></div>
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                ...
                                                <label for="wpie_field_mapping_comment_open" class="wpie_radio_label"><?php esc_html_e( 'Open', 'woo-import-export' ); ?></label>
                                        </div>
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                ...
                                                <label for="wpie_field_mapping_comment_closed" class="wpie_radio_label"><?php esc_html_e( 'Closed', 'woo-import-export' ); ?></label>
                                        </div>
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                ...
                                                <label for="wpie_field_mapping_comment_as_specified" class="wpie_radio_label"><?php esc_html_e( 'As specified', 'woo-import-export' ); ?></label>
                                                <div class="wpie_radio_container wpie_as_specified_wrapper">
                                                        ...
                                                        <i class="far fa-question-circle wpie_data_tipso" data-tipso="<?php esc_attr_e( "The value should be one of the following: ('open', 'closed').", "woo-import-export" ); ?>"></i>
                                                </div>
                                        </div>
                                </div>
                                <div class="wpie_field_mapping_container_element">
                                        <div class="wpie_field_mapping_inner_title"><?php esc_html_e( 'Trackbacks and Pingbacks', 'woo-import-export' ); ?></div>
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                ...
                                                <label for="wpie_item_ping_status_open" class="wpie_radio_label"><?php esc_html_e( 'Open', 'woo-import-export' ); ?></label>
                                        </div>
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                ...
                                                <label for="wpie_import_ping_status_closed" class="wpie_radio_label"><?php esc_html_e( 'Closed', 'woo-import-export' ); ?></label>
                                        </div>
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                ...
                                                <label for="wpie_import_ping_status_data" class="wpie_radio_label"><?php esc_html_e( 'As specified', 'woo-import-export' ); ?></label>
                                                <div class="wpie_radio_container wpie_as_specified_wrapper">
                                ...
                                <div class="wpie_field_mapping_container_element">
                                        <div class="wpie_field_mapping_inner_title"><?php esc_html_e( 'Post Slug', 'woo-import-export' ); ?></div>
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                <input type="text" class="wpie_content_data_input wpie_item_slug" name="wpie_item_slug" value=""/>
                                        </div>
                                </div>
                                <div class="wpie_field_mapping_container_element">
                                        <div class="wpie_field_mapping_inner_title"><?php esc_html_e( 'Post Password', 'woo-import-export' ); ?></div>
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                <input type="text" class="wpie_content_data_input wpie_item_post_password" name="wpie_item_post_password" value=""/>
                                        </div>
                                </div>
                                <div class="wpie_field_mapping_container_element">
                                        <div class="wpie_field_mapping_inner_title"><?php esc_html_e( 'Post Author', 'woo-import-export' ); ?></div>
                                        <div class="wpie_field_mapping_other_option_wrapper wpie_as_specified_wrapper">
                                                ...
                                                <i class="far fa-question-circle wpie_data_tipso" data-tipso="<?php esc_attr_e( "Assign the post to an existing user account by specifying the user ID, username, or e-mail address.", "woo-import-export" ); ?>"></i>
                                        </div>
                                </div>
                                <div class="wpie_field_mapping_container_element">
                                        <div class="wpie_field_mapping_inner_title"><?php esc_html_e( 'Download & Import Attachments', 'woo-import-export' ); ?></div>
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                ...
                                                <div class="wpie_field_mapping_post_attach_wrapper">
                                                        <div class="wpie_field_mapping_post_attach_sep_label"><?php esc_html_e( 'Separated by', 'woo-import-export' ); ?></div>
                                                ...
                                                <label for="wpie_item_attachement_search_for_existing" class="wpie_checkbox_label"><?php esc_html_e( 'Search for existing attachments to prevent duplicates in media library', 'woo-import-export' ); ?></label>
                                        </div>
                                </div>

                                <?php if ( $wpie_is_support_post_format ) { ?>
                                        <div class="wpie_field_mapping_container_element">
                                                <div class="wpie_field_mapping_inner_title"><?php echo esc_html( $wpie_import_type_title . " " . __( 'Format', 'woo-import-export' ) ); ?></div>
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                        ...
                                                        <label for="wpie_item_post_format_standard" class="wpie_radio_label"><?php esc_html_e( 'Standard', 'woo-import-export' ); ?></label>
                                                </div>
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                        ...
                                                        <label for="wpie_item_post_format_aside" class="wpie_radio_label"><?php esc_html_e( 'Aside', 'woo-import-export' ); ?></label>
                                                </div>
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                        ...
                                                        <label for="wpie_item_post_format_image" class="wpie_radio_label"><?php esc_html_e( 'Image', 'woo-import-export' ); ?></label>
                                                </div>
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                        ...
                                                        <label for="wpie_item_post_format_video" class="wpie_radio_label"><?php esc_html_e( 'Video', 'woo-import-export' ); ?></label>
                                                </div>
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                        ...
                                                        <label for="wpie_item_post_format_quote" class="wpie_radio_label"><?php esc_html_e( 'Quote', 'woo-import-export' ); ?></label>
                                                </div>
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                        ...
                                                        <label for="wpie_item_post_format_link" class="wpie_radio_label"><?php esc_html_e( 'Link', 'woo-import-export' ); ?></label>
                                                </div>
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                        ...
                                                        <label for="wpie_item_post_format_gallery" class="wpie_radio_label"><?php esc_html_e( 'Gallery', 'woo-import-export' ); ?></label>
                                                </div>
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                        ...
                                                        <label for="wpie_item_post_format_audio" class="wpie_radio_label"><?php esc_html_e( 'Audio', 'woo-import-export' ); ?></label>
                                                </div>
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                        ...
                                                        <label for="wpie_item_post_format_as_specified" class="wpie_radio_label"><?php esc_html_e( 'As specified', 'woo-import-export' ); ?></label>
                                ...
                                <?php if ( 'page' == $wpie_import_type || version_compare( $wp_version, '4.7.0', '>=' ) ) { ?>
                                        <div class="wpie_field_mapping_container_element">
                                                <div class="wpie_field_mapping_inner_title"><?php echo esc_html( $wpie_import_type_title . " " . __( 'Template', 'woo-import-export' ) ); ?></div>
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                        ...
                                                        <label for="wpie_item_template_as_specified" class="wpie_radio_label"><?php esc_html_e( 'As specified', 'woo-import-export' ); ?></label>
                                ...
                                <div class="wpie_field_mapping_container_element  wpie_field_mapping_data_option">
                                        <div class="wpie_field_mapping_inner_title"><?php echo esc_html( $wpie_import_type_title . " " . __( 'Parent', 'woo-import-export' ) ); ?></div>
                                        <?php if ( 'page' == $wpie_import_type ) { ?>
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                        ...
                                                        <label for="wpie_item_parent" class="wpie_radio_label"><?php esc_html_e( 'Select page parent', 'woo-import-export' ); ?></label>
                                                        <div class="wpie_field_mapping_option_wrapper" style="display: block;">
                                                                <?php wp_dropdown_pages( array( 'post_type' => 'page', 'selected' => '', 'class' => 'wpie_content_data_select', 'name' => 'wpie_item_parent_data', 'show_option_none' => __( '(no parent)', 'woo-import-export' ), 'sort_column' => 'menu_order, post_title', 'number' => 500 ) ); ?>
                                                        </div>
                                                </div>
                                        <?php } ?>
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                ...
                                                <label for="wpie_item_parent_as_specified" class="wpie_radio_label"><?php esc_html_e( 'As specified', 'woo-import-export' ); ?></label>
                                ...
                                <div class="wpie_field_mapping_container_element">
                                        <div class="wpie_field_mapping_inner_title"><?php esc_html_e( 'Menu Order', 'woo-import-export' ); ?></div>
                                        <div class="wpie_field_mapping_other_option_wrapper">
        ...
        function wpie_import_post_search_existing_item( $sections = "", $wpie_import_type = "" ) {
                ...
                <div class="wpie_field_mapping_container_element">
                        ...
                        <div class="wpie_field_mapping_other_option_wrapper">
                                ...
                                <label for="wpie_existing_item_search_logic_title" class="wpie_radio_label"><?php esc_html_e( 'Title', 'woo-import-export' ); ?></label>
                        </div>
                        <div class="wpie_field_mapping_other_option_wrapper">
                                ...
                                <label for="wpie_existing_item_search_logic_content" class="wpie_radio_label"><?php esc_html_e( 'Content', 'woo-import-export' ); ?></label>
                        </div>
                        <div class="wpie_field_mapping_other_option_wrapper">
                                ...
                                <label for="wpie_existing_item_search_logic_slug" class="wpie_radio_label"><?php esc_html_e( 'Slug', 'woo-import-export' ); ?></label>
                        ...
                        <div class="wpie_field_mapping_other_option_wrapper">
                                ...
                                <label for="wpie_existing_item_search_logic_cf" class="wpie_radio_label"><?php esc_html_e( 'Post Meta', 'woo-import-export' ); ?></label>
                                <div class="wpie_radio_container">
                        ...
                        <?php if ( $wpie_import_type == "product" ) { ?>
                                <div class="wpie_field_mapping_other_option_wrapper">
                                        ...
                                        <label for="wpie_existing_item_search_logic_sku" class="wpie_radio_label"><?php esc_html_e( 'SKU', 'woo-import-export' ); ?></label>
                        ...
                        <div class="wpie_field_mapping_other_option_wrapper">
                                ...
                                <label for="wpie_existing_item_search_logic_id" class="wpie_radio_label"><?php esc_html_e( 'Post ID', 'woo-import-export' ); ?></label>
                ...
                <div class="wpie_field_mapping_container_element">
                        ...
                        <?php if ( $wpie_import_type == "product" ) { ?>
                                <div class="wpie_field_mapping_other_option_wrapper">
                                        ...
                                        <label for="wpie_item_update_product_price_stock" class="wpie_radio_label"><?php esc_html_e( 'Update Price / Stock Only', 'woo-import-export' ); ?></label>
                                        <div class="wpie_radio_container">
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                        ...
                                                        <label for="is_update_item_product_price_data" class="wpie_checkbox_label"><?php esc_html_e( 'Price', 'woo-import-export' ); ?></label>
                                                        <div class="wpie_checkbox_container">
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_price_regular_price" class="wpie_checkbox_label"><?php esc_html_e( 'Regular Price', 'woo-import-export' ); ?></label>
                                                                </div>
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_price_sale_price" class="wpie_checkbox_label"><?php esc_html_e( 'Sale Price', 'woo-import-export' ); ?></label>
                                                                </div>
                                                ...
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                        ...
                                                        <label for="is_update_item_product_stock_data" class="wpie_checkbox_label"><?php esc_html_e( 'Stock', 'woo-import-export' ); ?></label>
                                                        <div class="wpie_checkbox_container">
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_stock_stock" class="wpie_checkbox_label"><?php esc_html_e( 'Stock Qty', 'woo-import-export' ); ?></label>
                                                                </div>
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_stock_manage_stock" class="wpie_checkbox_label"><?php esc_html_e( 'Manage stock?', 'woo-import-export' ); ?></label>
                                                                </div>
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_stock_stock_status" class="wpie_checkbox_label"><?php esc_html_e( 'Stock status', 'woo-import-export' ); ?></label>
                                                                </div>
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_stock_low_stock_amount" class="wpie_checkbox_label"><?php esc_html_e( 'Low stock threshold', 'woo-import-export' ); ?></label>
                                                                </div>
                                                        </div>
                                                </div>                                             
                                        </div>
                        ...
                        <div class="wpie_field_mapping_other_option_wrapper">
                                ...
                                <div class="wpie_radio_container">
                                        ...
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                ...
                                                <label for="is_update_item_post_status" class="wpie_checkbox_label"><?php esc_html_e( 'Post status', 'woo-import-export' ); ?></label>
                                        </div>
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                ...
                                                <label for="is_update_item_title" class="wpie_checkbox_label"><?php esc_html_e( 'Title', 'woo-import-export' ); ?></label>
                                        </div>
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                ...
                                                <label for="is_update_item_author" class="wpie_checkbox_label"><?php esc_html_e( 'Author', 'woo-import-export' ); ?></label>
                                        </div>
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                ...
                                                <label for="is_update_item_slug" class="wpie_checkbox_label"><?php esc_html_e( 'Slug', 'woo-import-export' ); ?></label>
                                        </div>
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                ...
                                                <label for="is_update_item_content" class="wpie_checkbox_label"><?php esc_html_e( 'Content / Description', 'woo-import-export' ); ?></label>
                                        </div>
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                ...
                                                <label for="is_update_item_excerpt" class="wpie_checkbox_label"><?php esc_html_e( 'Excerpt / Short Description', 'woo-import-export' ); ?></label>
                                        </div>
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                        ...
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                ...
                                                <label for="is_update_item_order" class="wpie_checkbox_label"><?php esc_html_e( 'Menu order', 'woo-import-export' ); ?></label>
                                        </div>
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                ...
                                                <label for="is_update_item_parent" class="wpie_checkbox_label"><?php esc_html_e( 'Parent post', 'woo-import-export' ); ?></label>
                                        </div>
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                ...
                                                <label for="is_update_item_post_type" class="wpie_checkbox_label"><?php esc_html_e( 'Post type', 'woo-import-export' ); ?></label>
                                        </div>
                                        <?php
                                        if ( $wpie_import_type == "product" ) {
                                                $commnet_status = __( 'Enable review setting', 'woo-import-export' );
                                        } else {
                                                $commnet_status = __( 'Comment status', 'woo-import-export' );
                                        }
                                        ...
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                ...
                                                <label for="is_update_item_ping_status" class="wpie_checkbox_label"><?php esc_html_e( 'Ping Status', 'woo-import-export' ); ?></label>
                                        </div>
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                ...
                                                <label for="is_update_item_post_password" class="wpie_checkbox_label"><?php esc_html_e( 'Post Password', 'woo-import-export' ); ?></label>
                                        </div>
                                        ...
                                        <?php if ( $wpie_import_type == "product" ) { ?>
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                        ...
                                                        <label for="is_update_item_product_type" class="wpie_checkbox_label"><?php esc_html_e( 'Product Type', 'woo-import-export' ); ?></label>
                                                </div>
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                        ...
                                                        <label for="is_update_item_product_general" class="wpie_checkbox_label"><strong><?php esc_html_e( 'Product General', 'woo-import-export' ); ?></strong></label>
                                                        <div class="wpie_checkbox_container">
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_general_sku" class="wpie_checkbox_label"><?php esc_html_e( 'SKU', 'woo-import-export' ); ?></label>
                                                                </div>
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_general_regular_price" class="wpie_checkbox_label"><?php esc_html_e( 'Regular Price', 'woo-import-export' ); ?></label>
                                                                </div>
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_general_sale_price" class="wpie_checkbox_label"><?php esc_html_e( 'Sale price', 'woo-import-export' ); ?></label>
                                                                </div>
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_general_sale_price_dates" class="wpie_checkbox_label"><?php esc_html_e( 'Sale price dates', 'woo-import-export' ); ?></label>
                                                                </div>
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_general_product_url" class="wpie_checkbox_label"><?php esc_html_e( 'Product URL', 'woo-import-export' ); ?></label>
                                                                </div>
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_general_button_text" class="wpie_checkbox_label"><?php esc_html_e( 'Button text', 'woo-import-export' ); ?></label>
                                                                </div>
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_general_virtual" class="wpie_checkbox_label"><?php esc_html_e( 'Virtual', 'woo-import-export' ); ?></label>
                                                                </div>
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_general_downloadable" class="wpie_checkbox_label"><?php esc_html_e( 'Downloadable', 'woo-import-export' ); ?></label>
                                                                </div>
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_general_downloadable_files" class="wpie_checkbox_label"><?php esc_html_e( 'Downloadable files', 'woo-import-export' ); ?></label>
                                                                </div>
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_general_download_limit" class="wpie_checkbox_label"><?php esc_html_e( 'Download limit', 'woo-import-export' ); ?></label>
                                                                </div>
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_general_download_expiry" class="wpie_checkbox_label"><?php esc_html_e( 'Download expiry', 'woo-import-export' ); ?></label>
                                                                </div>
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_general_tax_status" class="wpie_checkbox_label"><?php esc_html_e( 'Tax Status', 'woo-import-export' ); ?></label>
                                                                </div>
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_general_tax_class" class="wpie_checkbox_label"><?php esc_html_e( 'Tax Class', 'woo-import-export' ); ?></label>
                                                                </div>
                                                ...
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                        ...
                                                        <label for="is_update_item_product_inventory" class="wpie_checkbox_label"><strong><?php esc_html_e( 'Product Inventory', 'woo-import-export' ); ?></strong></label>
                                                        <div class="wpie_checkbox_container">
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_inventory_manage_stock" class="wpie_checkbox_label"><?php esc_html_e( 'Manage stock', 'woo-import-export' ); ?></label>
                                                                </div>                                                                
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_inventory_stock" class="wpie_checkbox_label"><?php esc_html_e( 'Stock Qty', 'woo-import-export' ); ?></label>
                                                                </div>                                                                
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_inventory_low_stock_amount" class="wpie_checkbox_label"><?php esc_html_e( 'Low stock threshold', 'woo-import-export' ); ?></label>
                                                                </div>                                                                
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_inventory_stock_status" class="wpie_checkbox_label"><?php esc_html_e( 'Stock status', 'woo-import-export' ); ?></label>
                                                                </div>                                                                
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_inventory_backorders" class="wpie_checkbox_label"><?php esc_html_e( 'Allow Backorders?', 'woo-import-export' ); ?></label>
                                                                </div>                                                                
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_inventory_sold_individually" class="wpie_checkbox_label"><?php esc_html_e( 'Sold Individually?', 'woo-import-export' ); ?></label>
                                                                </div>                                                                
                                                        </div>
                                                </div>  
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                        ...
                                                        <label for="is_update_item_product_shipping" class="wpie_checkbox_label"><?php esc_html_e( 'Product Shipping', 'woo-import-export' ); ?></label>
                                                        <div class="wpie_checkbox_container">
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_shipping_weight" class="wpie_checkbox_label"><?php esc_html_e( 'Weight', 'woo-import-export' ); ?></label>
                                                                </div>                                                                                                                                                                                               
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_shipping_dimensions" class="wpie_checkbox_label"><?php esc_html_e( 'Dimensions', 'woo-import-export' ); ?></label>
                                                                </div>                                                                                                                                                                                               
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_shipping_shipping_class" class="wpie_checkbox_label"><?php esc_html_e( 'Shipping Class', 'woo-import-export' ); ?></label>
                                                                </div>                                                                                                                                                                                               
                                                        </div>
                                                </div>  
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                        ...
                                                        <label for="is_update_item_product_linked_products" class="wpie_checkbox_label"><?php esc_html_e( 'Product Linked Products', 'woo-import-export' ); ?></label>
                                                        <div class="wpie_checkbox_container">
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_linked_products_up_sells" class="wpie_checkbox_label"><?php esc_html_e( 'Up Sells', 'woo-import-export' ); ?></label>
                                                                </div>                                                                                                                                                                                               
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_linked_products_cross_sells" class="wpie_checkbox_label"><?php esc_html_e( 'Cross Sells', 'woo-import-export' ); ?></label>
                                                                </div>                                                                                                                                                                                                                                                      
                                                        </div>
                                                </div> 
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                        ...
                                                        <label for="is_update_item_attributes" class="wpie_checkbox_label"><strong><?php esc_html_e( 'Product Attributes', 'woo-import-export' ); ?></strong></label>
                                                        <div class="wpie_checkbox_container">
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="wpie_item_update_attributes_all" class="wpie_radio_label"><?php esc_html_e( 'Update all Attributes and Remove Attributes if not found in file', 'woo-import-export' ); ?></label>
                                                                </div>
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="wpie_item_update_attributes_append" class="wpie_radio_label"><?php esc_html_e( 'Update all Attributes and keep Attributes if not found in file', 'woo-import-export' ); ?></label>
                                                                </div>
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="wpie_item_update_attributes_includes" class="wpie_radio_label"><?php esc_html_e( "Update only these Attributes, leave the rest alone", 'woo-import-export' ); ?></label>
                                                                        <div class="wpie_radio_container">
                                                                ...
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="wpie_item_update_attributes_excludes" class="wpie_radio_label"><?php esc_html_e( "Leave these attributes alone, update all other Attributes", 'woo-import-export' ); ?></label>
                                                                        <div class="wpie_radio_container">
                                                ...
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                        ...
                                                        <label for="is_update_item_product_variations" class="wpie_checkbox_label"><?php esc_html_e( 'Product Variations', 'woo-import-export' ); ?></label>
                                                        <div class="wpie_checkbox_container">
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_variations_enabled" class="wpie_checkbox_label"><?php esc_html_e( 'Variation Enabled', 'woo-import-export' ); ?></label>
                                                                </div>                                                                                                                               
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_variations_description" class="wpie_checkbox_label"><?php esc_html_e( 'Variation Description', 'woo-import-export' ); ?></label>
                                                                </div>                                                                                                                               
                                                        </div>
                                                </div>  
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                        ...
                                                        <label for="is_update_item_product_advanced" class="wpie_checkbox_label"><?php esc_html_e( 'Product Advanced', 'woo-import-export' ); ?></label>
                                                        <div class="wpie_checkbox_container">
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_advanced_purchase_note" class="wpie_checkbox_label"><?php esc_html_e( 'Purchase Note', 'woo-import-export' ); ?></label>
                                                                </div>                                                                                                                               
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_advanced_featured" class="wpie_checkbox_label"><?php esc_html_e( 'Featured', 'woo-import-export' ); ?></label>
                                                                </div>                                                                                                                               
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_advanced_catalog_visibility" class="wpie_checkbox_label"><?php esc_html_e( 'Catalog visibility', 'woo-import-export' ); ?></label>
                                                                </div>                                                                                                                               
                                                        </div>
                                                </div>  
                                        <?php } ?>                                     
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                ...
                                                <label for="is_update_item_attachments" class="wpie_checkbox_label"><?php esc_html_e( 'Attachments', 'woo-import-export' ); ?></label>
                                                <div class="wpie_checkbox_container">
                                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                                ...
                                                                <label for="wpie_item_update_attachments_all" class="wpie_radio_label"><?php esc_html_e( 'Update all Attachments', 'woo-import-export' ); ?></label>
                                                        </div>
                                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                                ...
                                                                <label for="wpie_item_update_attachments_append" class="wpie_radio_label"><?php esc_html_e( "Don't touch existing Attachments, append new Attachments", 'woo-import-export' ); ?></label>
                                                        </div>
                                                </div>
                                        </div>
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                ...
                                                <label for="is_update_item_images" class="wpie_checkbox_label"><?php esc_html_e( 'Images', 'woo-import-export' ); ?></label>
                                                <div class="wpie_checkbox_container">
                                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                                ...
                                                                <label for="wpie_item_update_images_all" class="wpie_radio_label"><?php esc_html_e( 'Update all images', 'woo-import-export' ); ?></label>
                                                        </div>
                                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                                ...
                                                                <label for="wpie_item_update_images_append" class="wpie_radio_label"><?php esc_html_e( "Don't touch existing images, append new images", 'woo-import-export' ); ?></label>
                                                        </div>
                                                </div>
                                        </div>
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                        ...
                                        <?php if ( class_exists( "ACF" ) ) { ?>
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                        ...
                                                        <label for="is_update_item_acf" class="wpie_checkbox_label"><?php esc_html_e( 'Advanced Custom Fields', 'woo-import-export' ); ?></label>
                                                </div>
                                        <?php } ?>
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                ...
                                                <label for="is_update_item_taxonomies" class="wpie_checkbox_label"><?php esc_html_e( 'Taxonomies (incl. Categories and Tags)', 'woo-import-export' ); ?></label>
                                                <div class="wpie_checkbox_container">
                                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                                ...
                                                                <label for="wpie_item_update_taxonomies_includes" class="wpie_radio_label"><?php esc_html_e( "Update only these taxonomies, leave the rest alone", 'woo-import-export' ); ?></label>
                                                                <div class="wpie_radio_container">
                                                        ...
                                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                                ...
                                                                <label for="wpie_item_update_taxonomies_excludes" class="wpie_radio_label"><?php esc_html_e( "Leave these taxonomies alone, update all others", 'woo-import-export' ); ?></label>
                                                                <div class="wpie_radio_container">
                                                        ...
                                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                                ...
                                                                <label for="wpie_item_update_taxonomies_all" class="wpie_radio_label"><?php esc_html_e( 'Remove existing taxonomies, add new taxonomies', 'woo-import-export' ); ?></label>
                                                        </div>
                                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                                ...
                                                                <label for="wpie_item_update_taxonomies_append" class="wpie_radio_label"><?php esc_html_e( 'Only add new', 'woo-import-export' ); ?></label>
                                                        </div>
                                                </div>
                                        </div>
                                        <?php if ( $is_yoast_added ) { ?>
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                        ...
                                                        <label for="is_update_item_yoast_seo" class="wpie_checkbox_label"><?php esc_html_e( 'Yoast SEO Data', 'woo-import-export' ); ?></label>
                                                </div>                                                
                                        <?php } ?>
