...
<td class="wpie_order_item_container wpie_advance_options_items">
        <div class="wpie_options_data wpie_order_item_row_option_wrapper">
                <div class="wpie_options_data_title"><?php esc_html_e( 'WC Order Product Items', 'woo-import-export' ); ?></div>
...
<td class="wpie_product_variations_container wpie_advance_options_items">
        <div class="wpie_options_data wpie_product_option_wrapper">
                <div class="wpie_options_data_title"><?php esc_html_e( 'Product Variations', 'woo-import-export' ); ?></div>
                <div class="wpie_options_data_content">
                        ...
                        <label for="wpie_product_variation_options_all" class="wpie_radio_label"><?php esc_html_e( 'Export product variations and their parent products', 'woo-import-export' ); ?></label>
                </div>                
                <div class="wpie_options_data_content">
                        ...
                        <label for="wpie_product_variation_options_child" class="wpie_radio_label"><?php esc_html_e( 'Only export product variations', 'woo-import-export' ); ?></label>
                </div>
                <div class="wpie_options_data_content">
                        ...
                        <label for="wpie_product_variation_options_parent" class="wpie_radio_label"><?php esc_html_e( 'Only export parent products', 'woo-import-export' ); ?></label>
                </div>
                <div class="wpie_export_default_warning wpie_export_product_variation_warning"><?php esc_html_e( 'Note : Export With Settings For Import option not available for only child or only parent product', 'woo-import-export' ); ?></div>
        </div>
</td>
<td class="wpie_wc_customer_container wpie_advance_options_items">
        <div class="wpie_options_data wpie_product_option_wrapper">
                <div class="wpie_options_data_title"><?php esc_html_e( 'Customer Options', 'woo-import-export' ); ?></div>
                <div class="wpie_options_data_content">
                        ...
                        <label for="wpie_export_only_customer_with_purchase" class="wpie_export_only_customer_with_purchase wpie_checkbox_label"><?php esc_html_e( 'Only export customers who have made a purchase ?', 'woo-import-export' ); ?></label>
                </div>
        </div>
</td>