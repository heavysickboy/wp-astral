        ...
        <div class="wpie_content_wrapper">
                <div class="wpie_section_wrapper">
                        <div class="wpie_content_data_header">
                                <div class="wpie_content_title"><?php esc_html_e( 'Purchase Code', 'woo-import-export' ); ?></div>
                        ...
                        <div class="wpie_section_content">
                                <div class="wpie_setting_element_wrapper wpie_license_activation_wrapper <?php echo esc_attr( $active_class ); ?>">
                                        <div class="wpie_setting_element_lable"><?php esc_html_e( 'Item Purchase Code', 'woo-import-export' ); ?></div>
                                        <div class="wpie_setting_element_data">
                                                ...
                                                <div class="wpie_setting_element_hint"><?php esc_html_e( 'A Purchase Code is required to access plugin updates and support.', 'woo-import-export' ); ?> <a href="<?php echo esc_url( "https://help.market.envato.com/hc/en-us/articles/202822600-Where-Is-My-Purchase-Code-" ); ?>" target="_blank"><?php esc_html_e( 'Click Here', 'woo-import-export' ); ?></a> <?php esc_html_e( 'For purchase code', 'woo-import-export' ); ?></div>
                                        </div>
                                ...
                                <div class="wpie_setting_element_wrapper wpie_license_deactivation_wrapper <?php echo esc_attr( $deactive_class ); ?>">
                                        <div class="wpie_setting_element_lable"><?php esc_html_e( 'Purchase Code Status', 'woo-import-export' ); ?></div>
                                        <div class="wpie_setting_element_data">
                ...
                <div class="wpie_section_wrapper">
                        <div class="wpie_content_data_header">
                                <div class="wpie_content_title"><?php esc_html_e( 'Background & Cron Processing', 'woo-import-export' ); ?></div>
                                <div class="wpie_layout_header_icon_wrapper"><i class="fas fa-chevron-up wpie_layout_header_icon wpie_layout_header_icon_collapsed" aria-hidden="true"></i><i class="fas fa-chevron-down wpie_layout_header_icon wpie_layout_header_icon_expand" aria-hidden="true"></i></div>
                        </div>
                        <div class="wpie_section_content">
                                <div class="wpie_setting_element_wrapper">
                                        <div class="wpie_doc_hint_container"><a class="wpie_doc_hint_url" href="<?php echo esc_url( 'https://plugins.vjinfotech.com/wordpress-import-export/article-categories/background-cron-processing/' ); ?>" target="_blank"><?php esc_html_e( 'Click Here', 'woo-import-export' ); ?></a> <?php esc_html_e( 'For More Details', 'woo-import-export' ); ?></div>
                                        <div class="wpie_field_mapping_radio_input_wrapper wpie_radio_wrapper">
                                                ...
                                                <label for="wpie_bg_and_cron_processing_wp" class="wpie_radio_label"><?php esc_html_e( 'Use WordPress Default Cron & processing', 'woo-import-export' ); ?></label>                                                       
                                        </div>
                                        <div class="wpie_field_mapping_radio_input_wrapper wpie_radio_wrapper">
                                                ...
                                                <label for="wpie_bg_and_cron_processing_external" class="wpie_radio_label"><?php esc_html_e( 'Use Web Host / External Cron & Processing', 'woo-import-export' ); ?></label>
                                                <div class="wpie_radio_container">
                                                        <div class="wpie_cron_url_wrapper">
                                                                <div class="wpie_cron_url_label"><?php esc_html_e( 'Use this single link for ALL schedule and background processing.', 'woo-import-export' ); ?></div> 
                                        ...
                                        <!--                                        <div class="wpie_setting_element_wrapper">
                                                                                        <div class="wpie_import_cap_container">
                                                                                                ...
                                                                                                <label for="wpie_bg_and_cron_processing_wp" class="wpie_radio_label"><?php esc_html_e( 'Delete All Data on plugin uninstall', 'woo-import-export' ); ?></label>
                                                                                        </div>
                                                                                        <div class="wpie_setting_element_btn">
                                                                                                <div class="wpie_btn wpie_btn_secondary wpie_btn_radius wpie_advanced_options_save">
                                                                                                        <i class="fas fa-check wpie_general_btn_icon " aria-hidden="true"></i><?php esc_html_e( 'Save', 'woo-import-export' ); ?>
