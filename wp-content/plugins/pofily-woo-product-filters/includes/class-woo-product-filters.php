...
class VIWCPF_Woo_Product_Filters {
	...
	/**
	 * Notification when active plugin without woocommerce
	 *
	 * @since    1.0.0
	 */
	function global_note() {
		if ( ! is_plugin_active( 'woocommerce/woocommerce.php' ) ) {
            ...
            <div id="message" class="error">
                <p><?php _e( 'Please install and activate WooCommerce to use Woocommerce Product Filters plugin.', 'pofily-woo-product-filters' ); ?></p>
            </div>
			<?php
		}
	}
